module Computation_Utils
    ...
    export py_sol, Trajectory, TangentODE

    export SolveODE, GetLEs

    export splitSol, getTanEigens

    using DifferentialEquations
    using ProgressMeter
    include("CallBack_Utils.jl"); using .CallBack_Utils

    ## Structure of solution like solve_ivp from SciPy ##
    struct py_sol{T<:Any}
        t::Vector{Float64}
    ...
    function (ode::TangentODE)(X::T, p = [], t = 0.0) where T
